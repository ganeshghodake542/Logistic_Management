...
const AuthPage = () => {
    ...
    return (
        <div className="min-h-screen flex items-center justify-center bg-gradient-to-b from-slate-50 to-slate-100 p-4">
            <div className="relative w-full max-w-5xl min-h-[610px] overflow-hidden rounded-3xl bg-white shadow-2xl ring-1 ring-slate-200">
                ...
                <div className="px-8 py-10  sm:px-10">
                    ...
                    {isLogin ? (
                        <form onSubmit={handleLoginSubmit} className="space-y-4">
                            ...
                            <p className="pt-4 text-center text-sm text-[#8A6A54]">
            ...
            bg-gradient-to-br from-blue-600 via-blue-600 to-indigo-700 text-white transition-all duration-700 ease-in-out lg:flex
                        ...
                        <div className="relative z-10 max-w-sm px-10 text-center">
                            ...
                            >
                                ...
                                <p className="mt-3 text-sm leading-relaxed text-blue-100">
                                    Create an account to apply to jobs, track applications, or
                                    start hiring top talent for your company.
                                </p>
                                <button
                                    onClick={() => navigate("/signup")}
                                    className="mt-8 rounded-lg border-2 border-white px-7 py-2.5 text-sm font-semibold transition hover:bg-white hover:text-blue-700"
                                >
                                    Create Account
                                </button>

                                {/* <div className="mt-12 grid grid-cols-3 gap-3 text-left">
                                <Stat label="Jobs" value="10K+" />
                                <Stat label="Companies" value="5K+" />
                            ...
                            >
                                ...
                                <p className="mt-3 text-sm leading-relaxed text-blue-100">
                                    Login to continue your job search or manage your job postings
                                    and applicants.
                                </p>
                                <button
                                    onClick={() => navigate("/login")}
